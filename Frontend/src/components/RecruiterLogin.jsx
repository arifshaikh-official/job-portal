...
const RecruiterLogin = () => {
  ...
  return (
    <div className='absolute top-0 left-0 right-0 bottom-0 z-11 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <button type='submit' className='bg-gray-600 w-full text-white py-2 rounded-full cursor-pointer mt-4'>
